        ...
        <div className="max-w-5xl mx-auto bg-white/95 backdrop-blur-md rounded-2xl p-6 sm:p-10 shadow-2xl">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <button 
              ...
              className="bg-red-500/200 hover:bg-red-600 text-white px-4 py-2 rounded-lg font-medium transition-colors flex items-center"
            >
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                  ...
                  <h3 className="font-bold text-white mb-2">My Profile & Balance</h3>
                  <p className="text-sm text-gray-300">View your personal info and outstanding balance.</p>
                </div>
                ...
                >
                  ...
                  <h3 className="font-bold text-white mb-2">Class Schedule</h3>
                  <p className="text-sm text-gray-300">View your weekly class schedule and rooms.</p>
                </div>
          ...
          {activeTab === 'profile' && (
            <div className="animate-fade-in-up">
              <button 
                ...
                className="text-gray-300 hover:text-white mb-6 font-medium inline-flex items-center transition-colors"
              >
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 max-w-2xl border-l-4 border-l-green-600 p-6 divide-y divide-gray-100">
                ...
                <div className="flex justify-between py-4">
                  <span className="text-gray-300 font-medium">LRN:</span>
                  <span className="font-semibold text-white">{currentUser.lrn || 'N/A'}</span>
                </div>
                <div className="flex justify-between py-4">
                  <span className="text-gray-300 font-medium">Student ID:</span>
                  <span className="font-semibold text-white">{currentUser.student_id || 'N/A'}</span>
                </div>
                <div className="flex justify-between py-4">
                ...
                <div className="flex justify-between py-4">
                  <span className="text-gray-300 font-medium">Enrollment Status:</span>
              ...
              <div className="overflow-x-auto bg-white rounded-xl shadow-sm border border-gray-100">
                <table className="w-full text-center">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    <tr>
                      <td className="p-4 font-semibold text-gray-300 bg-gray-50">08:00 AM - 09:30 AM</td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">Mathematics<br/><span className="font-normal text-sm">Room 101</span></td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">Science<br/><span className="font-normal text-sm">Lab A</span></td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">Mathematics<br/><span className="font-normal text-sm">Room 101</span></td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">Science<br/><span className="font-normal text-sm">Lab A</span></td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">Physical Ed.<br/><span className="font-normal text-sm">Gym</span></td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-gray-300 bg-gray-50">09:30 AM - 11:00 AM</td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">English<br/><span className="font-normal text-sm">Room 102</span></td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">History<br/><span className="font-normal text-sm">Room 205</span></td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">English<br/><span className="font-normal text-sm">Room 102</span></td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">History<br/><span className="font-normal text-sm">Room 205</span></td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">Computer<br/><span className="font-normal text-sm">Lab B</span></td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-gray-300 bg-gray-50">11:00 AM - 12:00 PM</td>
                      <td colSpan={5} className="p-4 bg-orange-500/20 text-orange-600 font-bold uppercase tracking-wider">LUNCH BREAK</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-gray-300 bg-gray-50">12:00 PM - 01:30 PM</td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">Values Ed.<br/><span className="font-normal text-sm">Room 105</span></td>
                      <td className="p-4 text-gray-400">-</td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">Values Ed.<br/><span className="font-normal text-sm">Room 105</span></td>
                      <td className="p-4 text-gray-400">-</td>
                      <td className="p-4 bg-green-500/20 text-green-800 font-bold rounded-lg m-1">Arts & Music<br/><span className="font-normal text-sm">Room 106</span></td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          {activeTab === 'announcements' && (
            <div className="animate-fade-in-up">
              ...
              {loadingAnnouncements ? (
                <p className="text-gray-300 animate-pulse">Checking for new announcements...</p>
              ) : announcements.length === 0 ? (
                <p className="text-gray-300">No announcements at this time.</p>
              ) : (
                  ...
                  {announcements.map((ann, i) => (
                    <div key={i} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 border-l-4 border-l-green-500">
                      <div className="text-sm text-gray-300 mb-3 font-medium">
                        Posted by <span className="font-bold text-white">{ann.author || 'Admin'}</span> • {new Date(ann.date).toLocaleDateString()}
                      </div>
                      <div className="text-white leading-relaxed whitespace-pre-wrap">{ann.message}</div>
                    </div>
                  ))}
                </div>
              )}
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-300 mt-1">PDF Document • {doc.size}</p>
                      </div>
                    </div>
